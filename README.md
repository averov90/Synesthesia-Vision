...
*Так же существуют функции для проигрывания SND-массивов (из WavUtils), но пока что в данном репозитории этих функций нет.*
<details>
...
*Так же существуют функции для озвучки текста на русском и перевода, но пока что в данном репозитории этих функций нет.*

### *Существует проект, созданный на основе этого. Скоро здесь появится ссылка на него.*
